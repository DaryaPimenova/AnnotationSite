const constants = {
    ...
    SAVE_IMAGE_DATA_REQUEST: "SAVE_IMAGE_DATA_REQUEST",
    SAVE_IMAGE_DATA_SUCCESSFUL: "SAVE_IMAGE_DATA_SUCCESSFUL",
    SAVE_IMAGE_DATA_FAILED: "SAVE_IMAGE_DATA_FAILED",

    LOAD_IMAGE_REQUEST: "LOAD_IMAGE_REQUEST",
    LOAD_IMAGE_SUCCESSFUL: "LOAD_IMAGE_SUCCESSFUL",
    LOAD_IMAGE_FAILED: "LOAD_IMAGE_FAILED",

    LOAD_IMAGE_FOR_UPDATE_REQUEST: "LOAD_IMAGE_FOR_UPDATE_REQUEST",
    LOAD_IMAGE_FOR_UPDATE_SUCCESSFUL: "LOAD_IMAGE_FOR_UPDATE_SUCCESSFUL",
    LOAD_IMAGE_FOR_UPDATE_FAILED: "LOAD_IMAGE_FOR_UPDATE_FAILED",
